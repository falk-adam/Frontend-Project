...
function NrOfGuestsMenu({ capacity, handleSetNrOfGuests }) {
  ...
  return (
    <ul className="bg-white absolute right-63 top-228 w-50 border-2 border-gray-400 rounded-lg shadow-lg overflow-hidden max-mobile:right-0 max-mobile:w-screen max-mobile:rounded-none max-mobile:top-15">
