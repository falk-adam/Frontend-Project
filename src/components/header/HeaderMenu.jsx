      ...
      <ul>
        ...
        {options.map((option, index) => (
          <Link to={option.url} key={index}>
            <li className="w-full h-8 p-2 pl-4 flex items-center text-[14px] hover:bg-gray-100 max-mobile:justify-center max-mobile:pl-2 max-mobile:text-[12px] max-mobile:h-6">
              {option.text}
            </li>
          </Link>
        ))}
